...
import EventAvailableIcon from '@material-ui/icons/History';
        ...
        >
            ...
            <List >
                ...
                <ListItem button component={Link} to="/dashboard/profile">
                    <ListItemIcon>
                        <AccountBoxIcon style={{color : "orange"}} />
                    </ListItemIcon>
                    <ListItemText>Account Info</ListItemText>
                </ListItem>
                <ListItem button component={Link} to="/dashboard/seat">
                    <ListItemIcon>
                        <ChairIcon style={{color : "green"}}/>
                    </ListItemIcon>
                    <ListItemText>Book A Seat</ListItemText>
                </ListItem>
                <ListItem button component={Link} to="/dashboard/history">
                    <ListItemIcon>
                        <EventAvailableIcon style={{color : "red"}}/>
                    </ListItemIcon>
                    <ListItemText>Travel History</ListItemText>
                </ListItem>
                <ListItem button component={Link} to="/dashboard/recharge">
                    <ListItemIcon>
                        <AttachMoneyIcon style={{color : "red"}}/>
                    </ListItemIcon>
                    <ListItemText>Recharge Account</ListItemText>
                </ListItem>
